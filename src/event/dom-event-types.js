...
export const TOP_ANIMATION_END = 'animationend'
export const TOP_ANIMATION_ITERATION  = 'animationiteration'
export const TOP_ANIMATION_START = 'animationstart'
...
export const TOP_TRANSITION_END = 'transitionend'
